...
class Quantization(nn.Module):
    def __init__(self, nbit=2, mode='mu'):
...
def decompress(y,x_sign,mu=50, mode='mu'):
    if mode == 'mu':
...
if __name__ == '__main__':
    q1 = Quantization(nbit=3, mode='mu')
    # q2 = Quantization(3,'mean')
